import { cart, addToCart } from "../data/cart.js"; // rememeber type at the top of the file when you use import 
import { products } from "../data/products.js"; // can be only work with live sever 
// can be renamed like cart as myCart
...
document.querySelectorAll('.js-add-to-cart')
  .forEach(buttons => {
    buttons.addEventListener('click', () => { // this is the name converted from HTML product-id
      const productId = buttons.dataset.productId; // The way can get data attribute from HTML
